...
The script performs the following operations:
    - use the read table function to read "./train/X_train.txt" 
    - use the read table function to read "./train/y_train.txt" 
    - use the read table function to read "./test/X_test.txt" 
    - use the read table function to read "./test/y_test.txt" 
    ...
    We generate a SQL query, which will be supplies to the sqldf function to calculate the averages by subject id and activity.
